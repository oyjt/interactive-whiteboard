...
function intervalControl() {
  ...
  function renderIconHoz(ctx: CanvasRenderingContext2D, left: number, top: number, styleOverride: any, fabricObject: Object) {
    const wsize = 25;
    const hsize = 20;
    ctx.save();
    ctx.translate(left, top);
...
function peakControl() {
  ...
  function renderIconEdge(ctx: CanvasRenderingContext2D, left: number, top: number, styleOverride: any, fabricObject: Object) {
    const wsize = 25;
    const hsize = 25;
    ctx.save();
    ctx.translate(left, top);
...
function deleteControl(canvas: Canvas) {
  ...
  function renderDelIcon(ctx: CanvasRenderingContext2D, left: number, top: number, styleOverride: any, fabricObject: Object) {
...
function rotationControl() {
  const img = document.createElement('img');
  img.src = rotateImg;
  function renderIconRotate(ctx: CanvasRenderingContext2D, left: number, top: number, styleOverride: any, fabricObject: Object) {
    const wsize = 40;
    const hsize = 40;
    ctx.save();
    ctx.translate(left, top);

<template>
  <div
    class="flex h-8 w-[60px] cursor-pointer select-none items-center justify-center rounded bg-white text-xs shadow-md"
  >
    <button
      class="mx-0.5 flex h-6 w-6 items-center justify-center rounded-sm hover:bg-gray-200"
      aria-label="撤销"
